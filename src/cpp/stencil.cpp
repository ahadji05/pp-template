...
template <>
void fd_pxx(ScalarField<ppt::MemSpaceHost> &pxx, const ScalarField<ppt::MemSpaceHost> &p, [[maybe_unused]] ppt::StreamHostType stream, ppt::ExecutionSpaceSerial)
{
...
template <>
void fd_pzz(ScalarField<ppt::MemSpaceHost> &pzz, const ScalarField<ppt::MemSpaceHost> &p, [[maybe_unused]] ppt::StreamHostType stream, ppt::ExecutionSpaceSerial)
{
...
template <>
void fd_pxx(ScalarField<ppt::MemSpaceHost> &pxx, const ScalarField<ppt::MemSpaceHost> &p, [[maybe_unused]] ppt::StreamHostType stream, ppt::ExecutionSpaceOpenMP)
{
    assert(pxx.get_nx() == p.get_nx());
    assert(pxx.get_nz() == p.get_nz());
...
template <>
void fd_pzz(ScalarField<ppt::MemSpaceHost> &pzz, const ScalarField<ppt::MemSpaceHost> &p, [[maybe_unused]] ppt::StreamHostType stream, ppt::ExecutionSpaceOpenMP)
{
    assert(pzz.get_nx() == p.get_nx());
    assert(pzz.get_nz() == p.get_nz());

...
template <>
void fd_time_extrap(ScalarField<TMP::MemSpaceHost> &pnew,
                    const ScalarField<TMP::MemSpaceHost> &p,
                    const ScalarField<TMP::MemSpaceHost> &pold,
                    const ScalarField<TMP::MemSpaceHost> &pxx,
                    const ScalarField<TMP::MemSpaceHost> &pzz,
                    const ScalarField<TMP::MemSpaceHost> &velmodel,
